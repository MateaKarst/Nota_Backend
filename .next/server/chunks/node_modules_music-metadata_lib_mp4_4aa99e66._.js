...
__turbopack_context__.s({
    ...
    "FixedLengthAtom": (()=>FixedLengthAtom),
    "Header": (()=>Header),
    "MdhdAtom": (()=>MdhdAtom),
    "Mp4ContentError": (()=>Mp4ContentError),
    "MvhdAtom": (()=>MvhdAtom),
    "NameAtom": (()=>NameAtom),
    "SampleToChunkToken": (()=>SampleToChunkToken),
    "SoundSampleDescriptionV0": (()=>SoundSampleDescriptionV0),
    "SoundSampleDescriptionVersion": (()=>SoundSampleDescriptionVersion),
    "StcoAtom": (()=>StcoAtom),
    "StscAtom": (()=>StscAtom),
    "StsdAtom": (()=>StsdAtom),
    "StszAtom": (()=>StszAtom),
    "SttsAtom": (()=>SttsAtom),
    "TimeToSampleToken": (()=>TimeToSampleToken),
...
class MP4Parser extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$common$2f$BasicParser$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BasicParser"] {
    constructor(){
        ...
        this.atomParsers = {
             ...
             */ mdhd: async (len)=>{
                const mdhd_data = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$mp4$2f$AtomToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MdhdAtom"](len));
            ...
            tkhd: async (len)=>{
                const track = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$mp4$2f$AtomToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TrackHeaderAtom"](len));
             ...
             */ stsc: async (len)=>{
                const stsc = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$mp4$2f$AtomToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StscAtom"](len));
                this.getTrackDescription().sampleToChunkTable = stsc.entries;
            },
            /**
             * time-to-sample table
             */ stts: async (len)=>{
                const stts = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$mp4$2f$AtomToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SttsAtom"](len));
             ...
             */ stco: async (len)=>{
                const stco = await this.tokenizer.readToken(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$music$2d$metadata$2f$lib$2f$mp4$2f$AtomToken$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["StcoAtom"](len));
                ...
                default:
                    {
                        ...
                        this.addWarning(`Unsupported meta-item: ${tagKey}[${child.header.name}] => value=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8array$2d$extras$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uint8ArrayToHex"])(uint8Array)} ascii=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8array$2d$extras$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uint8ArrayToString"])(uint8Array, 'ascii')}`);
                    }
            }
...
//# sourceMappingURL=node_modules_music-metadata_lib_mp4_4aa99e66._.js.map